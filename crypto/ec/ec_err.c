...
static const ERR_STRING_DATA EC_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_EC, EC_F_OQS_ITEM_VERIFY, 0), "oqs_item_verify"},
    {ERR_PACK(ERR_LIB_EC, EC_F_OQS_KEY_INIT, 0), "oqs_key_init"},
    {ERR_PACK(ERR_LIB_EC, EC_F_OQS_PRIV_DECODE, 0), "oqs_priv_decode"},
    {ERR_PACK(ERR_LIB_EC, EC_F_OQS_PRIV_ENCODE, 0), "oqs_priv_encode"},
    {ERR_PACK(ERR_LIB_EC, EC_F_OQS_PUB_DECODE, 0), "oqs_pub_decode"},
    {ERR_PACK(ERR_LIB_EC, EC_F_OQS_PUB_ENCODE, 0), "oqs_pub_encode"},
    {ERR_PACK(ERR_LIB_EC, EC_F_OQS_SIZE, 0), "oqs_size"},
...
static const ERR_STRING_DATA EC_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_BUFFER_LENGTH_WRONG), "buffer length wrong"},
    ...
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_KEYGEN_FAILED), "keygen failed"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_KEYS_NOT_SET), "keys not set"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_KEY_INIT_FAILED), "key init failed"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_KEY_LENGTH_WRONG), "key length wrong"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_KEY_NOT_SET), "key not set"},
    ...
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_NO_PRIVATE_KEY), "no private key"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_NO_PRIVATE_VALUE), "no private value"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_NO_SUCH_OQS_ALGORITHM),
    "no such oqs algorithm"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_OPERATION_NOT_SUPPORTED),
    "operation not supported"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_PARAMETERS_MUST_BE_ABSENT),
    ...
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_SETTING_PARAMETERS_FAILED),
    "setting parameters failed"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_SHARED_INFO_ERROR), "shared info error"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_SIGNING_FAILED), "signing failed"},
    ...
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_UNKNOWN_NID), "unknown nid"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_UNKNOWN_ORDER), "unknown order"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_UNSUPPORTED_FIELD), "unsupported field"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_VERIFICATION_FAILED), "verification failed"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_WRONG_CURVE_PARAMETERS),
    "wrong curve parameters"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_WRONG_DIGEST), "wrong digest"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_WRONG_LENGTH), "wrong length"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_WRONG_ORDER), "wrong order"},
    {ERR_PACK(ERR_LIB_EC, 0, EC_R_WRONG_PARAMETERS), "wrong parameters"},
    {0, NULL}
};
